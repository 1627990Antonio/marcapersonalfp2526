...
class ProyectosController extends Controller
{
    ...
    public function getShow($id)
    {
        ...
        //El guión mayor que (->) se usa para acceder a métodos y propiedades de un objeto en PHP
            ->with('proyectos', $this->arrayProyectos[$id])
            ->with('id', $id);
    }
    public function getEdit($id)
    {
        //El igual mayor que (=>) se usa para definir pares clave-valor en arrays asociativos en PHP
        return view('proyectos.edit', array('proyectos' => $this->arrayProyectos[$id]));
    }
